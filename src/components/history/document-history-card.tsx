...
export function DocumentHistoryCard({ entry, onClick }: Props) {
  return (
    <button
      type="button"
      onClick={onClick}
      className="w-full text-left glass rounded-xl p-5 insight-card-hover"
    >
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-center gap-3 mt-1.5 flex-wrap">
            <span className="text-xs text-warm-black/35 dark:text-warm-white/25 font-mono">
            ...
            <span className="px-2 py-0.5 rounded-full text-[10px] font-medium bg-warm-gray dark:bg-white/5 text-warm-black/40 dark:text-warm-white/30 capitalize">
              {entry.mode}
            </span>
          </div>
        </div>
        ...
        <div className="shrink-0 text-right">
          ...
          <p className="text-[10px] text-warm-black/30 dark:text-warm-white/20 font-mono uppercase tracking-wider">
            net flow
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4 mt-3 pt-3 border-t border-warm-gray dark:border-warm-white/5">
        <span className="text-xs text-warm-black/45 dark:text-warm-white/35">
          {entry.insightCount} {entry.insightCount === 1 ? "finding" : "findings"}
        </span>
        {entry.topFinding && (
          <span className="text-xs text-warm-black/35 dark:text-warm-white/25 truncate">
