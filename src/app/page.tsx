...
export default function Home() {
  return (
    <div className="relative min-h-screen bg-warm-black text-warm-white overflow-hidden">
      {/* Animated gradient background */}
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-br from-amber-900/20 via-warm-black to-sage-900/20 animate-pulse" style={{ animationDuration: "8s" }} />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={item.step}
                className="animate-fade-up glass rounded-2xl p-8 flex flex-col gap-4 border-white/5"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div
                key={f.title}
                className="animate-fade-up flex gap-4 p-6 rounded-xl glass border-white/5 hover:border-amber-500/20 transition-colors group"
                style={{ animationDelay: `${i * 0.1}s`, opacity: 0 }}
              >
                <div className="shrink-0 w-10 h-10 rounded-xl bg-amber-500/10 flex items-center justify-center text-amber-500 group-hover:bg-amber-500 group-hover:text-warm-black transition-all">
                  {f.icon}
                </div>
                <div>
      ...
      <section className="relative z-10 py-24 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <div className="glass rounded-3xl p-12 sm:p-16 border-white/5 relative overflow-hidden">
